...
# - **No business logic**: JSON:API attribute unwrapping, latitude/longitude casting, conformed keys, and agency tagging all belong in Silver — not here.
...
SOURCE_ENDPOINT = "/stops"
SOURCE_SYSTEM   = "mbta"
BRONZE_TABLE    = "bronze_mbta_stops_raw"
API_MODE        = "live"  # "live" | "cached"
FIXTURE_PATH    = "../../fixtures/bronze/mbta_stops_sample.json"
